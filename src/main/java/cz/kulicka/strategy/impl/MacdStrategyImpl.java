...
public class MacdStrategyImpl extends AbstractStrategy implements OrderStrategy {
    ...
    protected MacdStrategyImpl(BinanceApiService binanceApiService, MacdIndicatorService macdIndicatorService, OrderService orderService, PropertyPlaceholder propertyPlaceholder) {
