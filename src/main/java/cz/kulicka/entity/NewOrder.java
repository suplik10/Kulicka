...
import cz.kulicka.enums.NewOrderRespType;
...
public class NewOrder {
     ...
     */
    public NewOrder(String symbol, OrderSide side, OrderType type, long timestamp, String quantity) {
        this.symbol = symbol;
        this.side = side;
        this.type = type;
     ...
     */
    public NewOrder(String symbol, OrderSide side, OrderType type, long timestamp, String quantity, String price) {
        this(symbol, side, type, timestamp, quantity);
        this.price = price;
    }
     ...
     */
    public static NewOrder marketBuy(String symbol, String quantity, long timestamp) {
        return new NewOrder(symbol, OrderSide.BUY, OrderType.MARKET, timestamp, quantity);
    }
     ...
     */
    public static NewOrder marketSell(String symbol, String quantity, long timestamp) {
        return new NewOrder(symbol, OrderSide.SELL, OrderType.MARKET, timestamp, quantity);
    }
     ...
     */
    public static NewOrder limitBuy(String symbol, TimeInForce timeInForce, String quantity, String price, long timestamp) {
        return new NewOrder(symbol, OrderSide.BUY, OrderType.LIMIT, timestamp, quantity, price);
    }
     ...
     */
    public static NewOrder limitSell(String symbol, TimeInForce timeInForce, String quantity, String price,long timestamp) {
        return new NewOrder(symbol, OrderSide.SELL, OrderType.LIMIT, timestamp, quantity, price);
    }
